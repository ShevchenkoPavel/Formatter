...
public class lexerStateMachine {
    ...
    private IState cycleForBraceState = new SimpleState("cycleForBraceState");
    ...
    private void createMap() {
        ...
        cycleForMap.put("(", cycleForBraceState);
        cycleForMap.put("}", defaultState);

        HashMap<String, IState> cycleForBraceStateMap = new HashMap<>();
        cycleForBraceStateMap.put(")", cycleForState);
        ...
        stateMap.put(cycleForBraceState, cycleForBraceStateMap);
    }
